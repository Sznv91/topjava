...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Еда второго пользователя", 410),
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Вторая Еда второго пользователя", 440),
            new Meal(3, LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Еда Третьего пользователя", 410)
